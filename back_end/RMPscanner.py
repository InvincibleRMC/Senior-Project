...
def loadProfessorName(URL: str, parsedPage: BeautifulSoup):
...
def loadProfessorScore(URL: str, parsedPage: BeautifulSoup):
    score = parsedPage.find("div", class_="RatingValue__Numerator-qw8sqy-2 liyUjw")
    return score.text.strip()


def loadProfessorDepartment(URL: str, parsedPage: BeautifulSoup):
...
def loadTakeAgainAnDifficulty(URL: str, parsedPage: BeautifulSoup):
    scores = []
...
def loadReviews(URL: str, parsedPage: BeautifulSoup):
