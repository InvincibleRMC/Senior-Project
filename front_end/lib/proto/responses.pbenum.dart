...
class ResponseType extends $pb.ProtobufEnum {
  static const ResponseType RES_COURSES = ResponseType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'RES_COURSES');
  static const ResponseType RES_PROFS = ResponseType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'RES_PROFS');
  static const ResponseType RES_SCHEDULE = ResponseType._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'RES_SCHEDULE');
