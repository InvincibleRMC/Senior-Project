...
class NotificationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NotificationRequest', createEmptyInstance: create)
    ...
    ..pc<Course>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'classes', $pb.PbFieldType.PM, subBuilder: Course.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<Course> get classes => $_getList(1);
}
...
class ScheduleRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ScheduleRequest', createEmptyInstance: create)
    ...
    ..pc<Course>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'previousClasses', $pb.PbFieldType.PM, protoName: 'previousClasses', subBuilder: Course.create)
    ..pc<Course>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'preferredClasses', $pb.PbFieldType.PM, protoName: 'preferredClasses', subBuilder: Course.create)
    ..pc<Course>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unpreferredClasses', $pb.PbFieldType.PM, protoName: 'unpreferredClasses', subBuilder: Course.create)
  ...
  factory ScheduleRequest({
    $core.String? major,
    $core.Iterable<Course>? previousClasses,
    $core.Iterable<Course>? preferredClasses,
    $core.Iterable<Course>? unpreferredClasses,
  ...
  @$pb.TagNumber(2)
  $core.List<Course> get previousClasses => $_getList(1);

  @$pb.TagNumber(3)
  $core.List<Course> get preferredClasses => $_getList(2);

  @$pb.TagNumber(4)
  $core.List<Course> get unpreferredClasses => $_getList(3);
