...
class ScheduleResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ScheduleResponse', createEmptyInstance: create)
    ..m<$core.String, $2.CourseList>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'courseMap', entryClassName: 'ScheduleResponse.CourseMapEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $2.CourseList.create)
    ..hasRequiredFields = false
  ;

  ScheduleResponse._() : super();
  factory ScheduleResponse({
    $core.Map<$core.String, $2.CourseList>? courseMap,
  }) {
  ...
  @$pb.TagNumber(1)
  $core.Map<$core.String, $2.CourseList> get courseMap => $_getMap(0);
}
