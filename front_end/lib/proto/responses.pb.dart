...
class CourseList extends $pb.GeneratedMessage {
  ...
  factory CourseList.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CourseList.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  CourseList copyWith(void Function(CourseList) updates) =>
      super.copyWith((message) => updates(message as CourseList))
          as CourseList; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static CourseList getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CourseList>(create);
...
class ScheduleResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names')
          ...
          : 'ScheduleResponse',
      createEmptyInstance: create)
    ..m<$core.String, CourseList>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'courseMap',
        entryClassName: 'ScheduleResponse.CourseMapEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: CourseList.create)
    ..hasRequiredFields = false;
...
class ProfessorResponse extends $pb.GeneratedMessage {
  ...
  factory ProfessorResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ProfessorResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ProfessorResponse copyWith(void Function(ProfessorResponse) updates) =>
      super.copyWith((message) => updates(message as ProfessorResponse))
          as ProfessorResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ProfessorResponse create() => ProfessorResponse._();
  ProfessorResponse createEmptyInstance() => create();
  static $pb.PbList<ProfessorResponse> createRepeated() =>
      $pb.PbList<ProfessorResponse>();
  @$core.pragma('dart2js:noInline')
  static ProfessorResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ProfessorResponse>(create);
...
class CourseResponse extends $pb.GeneratedMessage {
  ...
  factory CourseResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CourseResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CourseResponse copyWith(void Function(CourseResponse) updates) =>
      super.copyWith((message) => updates(message as CourseResponse))
          as CourseResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CourseResponse create() => CourseResponse._();
  CourseResponse createEmptyInstance() => create();
  static $pb.PbList<CourseResponse> createRepeated() =>
      $pb.PbList<CourseResponse>();
  @$core.pragma('dart2js:noInline')
  static CourseResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CourseResponse>(create);
...
class DebugResponse extends $pb.GeneratedMessage {
  ...
  factory DebugResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DebugResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  DebugResponse copyWith(void Function(DebugResponse) updates) =>
      super.copyWith((message) => updates(message as DebugResponse))
          as DebugResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DebugResponse create() => DebugResponse._();
  DebugResponse createEmptyInstance() => create();
  static $pb.PbList<DebugResponse> createRepeated() =>
      $pb.PbList<DebugResponse>();
  @$core.pragma('dart2js:noInline')
  static DebugResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DebugResponse>(create);
...
class MajorResponse extends $pb.GeneratedMessage {
  ...
  factory MajorResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory MajorResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  MajorResponse copyWith(void Function(MajorResponse) updates) =>
      super.copyWith((message) => updates(message as MajorResponse))
          as MajorResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static MajorResponse create() => MajorResponse._();
  MajorResponse createEmptyInstance() => create();
  static $pb.PbList<MajorResponse> createRepeated() =>
      $pb.PbList<MajorResponse>();
  @$core.pragma('dart2js:noInline')
  static MajorResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<MajorResponse>(create);
